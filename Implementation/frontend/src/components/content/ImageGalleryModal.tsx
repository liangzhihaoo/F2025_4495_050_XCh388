...
export default function ImageGalleryModal({ item, open, startIndex = 0, onClose }: Props) {
  ...
  return (
    <>
      <div className="fixed inset-0 bg-black/80 z-50" onClick={handleBackdropClick} />
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div className="relative max-w-4xl max-h-[90vh] w-full">
          {/* Close Button */}
          <button
            onClick={onClose}
            className="absolute top-4 right-4 z-10 p-2 text-white hover:bg-black/20 rounded-full transition-colors"
